const ReadSettingIcon = ({className, stroke}:{className?:string, stroke?:string}) => {
    return (
       <svg
          ...
          viewBox="0 0 22 22"
          fill="none"
          class={`text-subtitle-color size-5 transition-all duration-200 ${className}`}
       >
          <path
...
export default ReadSettingIcon;