...
const Header = () => {
   ...
   return (
      <header
         className={` ${isScrolled ? 'hidden' : 'sticky top-0 z-30 border-b border-border'}`}
      >
         <div className="flex items-center justify-between px-4 md:px-6 py-3">
            <div>
               <h1 className="text-lg font-semibold leading-tight">Quran Mazid</h1>
            ...
            <div className="flex items-center gap-2">
               ...
               <button className="grid h-10 w-10 place-items-center rounded-full bg-primary-soft text-primary hover:bg-accent transition llg:hidden">
